...
:parameters ( ?t - taxi ?l - location)
:precondition 
(and (at p6 ?l) (at ?t ?l) (empty ?t))
:effect 
(and (not (empty ?t)) (not (at p6 ?l)) (in p6 ?t))
)

(:action exit_p6
:parameters ( ?t - taxi ?l - location)
:precondition 
(and (in p6 ?t) (at ?t ?l) (goal-of p6 ?l))
:effect 
(and (not (in p6 ?t)) (empty ?t) (at p6 ?l))
)

(:action enter_p7
:parameters ( ?t - taxi ?l - location)
:precondition 
(and (at p7 ?l) (at ?t ?l) (empty ?t))
:effect 
(and (not (empty ?t)) (not (at p7 ?l)) (in p7 ?t))
)

(:action exit_p7
:parameters ( ?t - taxi ?l - location)
:precondition 
(and (in p7 ?t) (at ?t ?l) (goal-of p7 ?l))
:effect 
(and (not (in p7 ?t)) (empty ?t) (at p7 ?l))
)
...
:parameters ( ?from - location ?to - location)
:precondition 
(and (at t3 ?from) (directly-connected ?from ?to) (free ?to))
:effect 
(and (not (at t3 ?from)) (not (free ?to)) (at t3 ?to) (free ?from))
)
